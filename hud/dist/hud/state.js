        ...
        try {
            ...
            if (settings.hveHud) {
                return mergeWithDefaults({
                    ...
                    missionBoard: mergeMissionBoardConfig(legacyConfig?.missionBoard, settings.hveHud.missionBoard),
                });
            }
        }
        catch (error) {
...
/**
 * Write HUD configuration to ~/.claude/settings.json (hveHud key)
 */
