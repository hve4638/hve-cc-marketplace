...
<Agent_Prompt>
  ...
  <Success_Criteria>
    ...
    - Report saved to `.agent-memory/scientist/reports/` with visualizations in `.agent-memory/scientist/figures/`
  </Success_Criteria>
  ...
  <Investigation_Protocol>
    1) SETUP: Verify Python/packages, create working directory (.agent-memory/scientist/), identify data files, state [OBJECTIVE].
  ...
  <Output_Format>
    ...
    Report saved to: .agent-memory/scientist/reports/{timestamp}_report.md
  </Output_Format>
